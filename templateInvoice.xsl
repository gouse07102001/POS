        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block font-size="12pt" text-align="center" font-family="Helvetica" font-weight="bold" space-after="5mm">
                        Ordered At-<xsl:value-of select="time"/>
                    </fo:block>
                    <fo:block font-size="10pt">
                        <fo:table table-layout="fixed" width="100%" border-collapse="separate">
                            ...
                            <fo:table-header font-weight="bold">
                                ...
                                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                                    <fo:block font-size="15pt" text-align="center" font-weight="bold">SellingPrice</fo:block>
                                </fo:table-cell>
                                <fo:table-cell border="1pt solid black" xsl:use-attribute-sets="tableBorder">
                    ...
                    <fo:block font-size="15pt" font-family="Helvetica" text-align="right" color="black" font-weight="bold" space-after="10mm">
                    Total:<xsl:value-of select="totalAmount"/>
                    </fo:block>
                </fo:flow>
            </fo:page-sequence>
        </fo:root>
