...
public class InventoryServiceTest extends AbstractUnitTest {
	...
	public void testUpdate() throws Exception {
		...
		try{
			inventoryService.update(1000, ip.getQuantity());
		}
		catch(Exception e){
			assertEquals("Inventory with given ID does not exist",e.getMessage());
		}
	}
	...
	public void testGetInventory() throws Exception {
		...
		assertEquals(inventoryPojo.getQuantity(), inventoryPojoFinal.getQuantity());
		try{
			inventoryPojoFinal = inventoryService.getInventory(1000);
		}
		catch(Exception e){
			assertEquals("Inventory with given id does not exist",e.getMessage());
		}
